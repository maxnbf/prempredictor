...
const LeaderBoard = () => {
    ...
    const [dropdownLeaderboard, setDropdownLeaderboard] = useState(options[0].value)
    ...
    return <div>
        ...
        <StyledDropdown options={options} onChange={onSelect} value={dropdownLeaderboard} placeholder="Select an option" />
        ...
        <div>
            ...
            {dropdownLeaderboard === 'community' && <CommunityRanking ranking={commRanking} />}
        </div>
    </div>
}
