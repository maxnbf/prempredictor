...
const NewUserHomePage = () => {
  ...
  const saveTable = () => {
    if (favorite) {
      makeRanking({ teams, favorite }).then((res) => {
    ...
    <NewUserContainer>
      <NewUserInstructions>
        <InstructionsContent>
          ...
          <li>
            Drag and drop the teams to the right to make your predicted final
            standings
          </li>
      ...
      <NewUserSaveContainer>
        <NewUserSaveButtonContainer>
          ...
          {!favorite && (
            <ErrorMessage>
              *Please select a favorite team before saving
            </ErrorMessage>
          )}
        </NewUserSaveButtonContainer>
      </NewUserSaveContainer>
