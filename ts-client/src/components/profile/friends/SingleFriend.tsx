...
export const SingleFriend = ({ friend }: SingleFriendProps) => {
    ...
    return (
        ...
        <ListItemText
            ...
            />
            {isFriend ?
                <Button onClick={() => removeFriend()} variant="outlined">Remove Friend</Button>
                :
                isRequest 
                    ? <Button disabled={true} variant="outlined">Requested</Button>
                    : <Button onClick={() => addFriend()} variant="outlined">Add Friend</Button>
