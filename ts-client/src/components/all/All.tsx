        ...
        <Table>
          <TableHead>
            <TableRow sx={{ height: 15 }}>
              <TableCell sx={{ height: 15, padding: 1 }} colSpan={3}>
                Rank
              </TableCell>
              <TableCell sx={{ height: 15, padding: 1 }} colSpan={6}>
                User
              </TableCell>
              <TableCell sx={{ height: 15, padding: 1 }} colSpan={3} align="right">
                Score
              </TableCell>
            </TableRow>
          </TableHead>
          <TableBody>
            {paginatedData.map((row, idx) => (
              <TableRow
                ...
                onClick={() => navigateToUser(row.username)}
              >
                <TableCell sx={{ height: 15, padding: 1 }} colSpan={3}>
