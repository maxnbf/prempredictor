...
export const Home = () => {
            ...
            <Box sx={{ pb: 8, zIndex: 1 }}>
                {isLoading ? (
                    <Container maxWidth="md">
                        ...
                        <Container maxWidth="md">
                            <TableView setLive={setLive} live={live} myTable={myTable} otherTable={otherTable} currentGameWeek={currentGameWeek} />
                        </Container>
                ) : myTable === null ? (
                    <Container maxWidth="md"><NewUserOnboarding /></Container>
                ) : (
    ...
    return (
        <NavLayout disableNav={myTable === null}>
            {renderContent()}
        </NavLayout>
    );
};
