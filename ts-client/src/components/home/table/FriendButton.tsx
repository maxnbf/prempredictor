...
export const FriendButton = ({ activeUser, otherUsername }: FriendButtonProps) => {
  ...
  if (isFriends) {
    return (
      <Button variant="outlined" onClick={() => removeFriend(otherUsername)}>
        Remove Friend
      </Button>
    );
    ...
    if (friendRequest.to == activeUser && friendRequest.from == otherUsername) {
      return (
        <Button variant="outlined" onClick={() => acceptRequest(friendRequest.from)}>
          Accept Request
        </Button>
      );
    } else {
    ...
    return (
      <Button variant="outlined" onClick={() => sendRequest(otherUsername)}>
        Add Friend
      </Button>
    );
  }
