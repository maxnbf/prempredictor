...
export const makeRanking = (data: any): Promise<AxiosResponse> => {
  return new Promise((resolve, reject) => {
    axios
      .post('http://10.0.0.169:80/api/myTable/ranking', data)
...
export const getRanking = (user: string): Promise<UserRanking> => {
  return new Promise((resolve, reject) => {
    axios
      .get(`http://10.0.0.169:80/api/myTable/${user}/ranking`)
      .then((res: AxiosResponse) => {
...
export const getLiveRanking = (): Promise<LiveRanking> => {
  return new Promise((resolve, reject) => {
    axios
      .get('http://10.0.0.169:80/api/myTable/live')
      .then((res: AxiosResponse) => {
...
export const getAllRanking = (): Promise<AxiosResponse> => {
  return new Promise((resolve, reject) => {
    axios
      .get('http://10.0.0.169:80/api/myTable/leaderboard')
      .then((res: AxiosResponse) => {
        resolve(res);
      })
      .catch((err) => {
...
export const getFanRanking = (favorite: string): Promise<AxiosResponse> => {
  return new Promise((resolve, reject) => {
    axios
      .get(`http://10.0.0.169:80/api/myTable/${favorite}/rankingByFavorite`)
      .then((res: AxiosResponse) => {
        resolve(res);
      })
      .catch((err) => {
...
export const getTimeSeriesPoints = (user: string): Promise<TimeSeriesPoints[]> => {
  return new Promise((resolve, reject) => {
    axios
      .get(`http://10.0.0.169:80/api/myTable/${user}/getTimeSeriesPoints`)
      .then((res: AxiosResponse) => {
...
export const getLiveRankingForGameWeek = (gameWeek: string): Promise<LiveRanking> => {
  return new Promise((resolve, reject) => {
    axios
      .get(`http://10.0.0.169:80/api/myTable/${gameWeek}/liveRanking`)
      .then((res: AxiosResponse) => {
...
//   return new Promise((resolve, reject) => {
//     axios
//       .get("http://10.0.0.169:80/api/ranking/community_ranking")
//       .then((res: AxiosResponse) => {
//         resolve(res);
//       })
//       .catch((err) => {
