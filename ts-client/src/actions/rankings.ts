...
export const makeRanking = (data: any): Promise<AxiosResponse> => {
  return new Promise((resolve, reject) => {
    axios
      .post('http://10.0.0.1698080api/myTable/ranking', data)
...
export const getRanking = (user: string): Promise<UserRanking> => {
  return new Promise((resolve, reject) => {
    axios
      .get(`http://10.0.0.1698080api/myTable/${user}/ranking`)
      .then((res: AxiosResponse) => {
...
export const getLiveRanking = (): Promise<LiveRanking> => {
  return new Promise((resolve, reject) => {
    axios
      .get('http://10.0.0.1698080api/myTable/live')
      .then((res: AxiosResponse) => {
...
export const getAllRanking = (): Promise<AxiosResponse> => {
  return new Promise((resolve, reject) => {
    axios
      .get('http://10.0.0.1698080api/myTable/leaderboard')
      .then((res: AxiosResponse) => {
        resolve(res);
      })
      .catch((err) => {
...
export const getFanRanking = (favorite: string): Promise<AxiosResponse> => {
  return new Promise((resolve, reject) => {
    axios
      .get(`http://10.0.0.1698080api/myTable/${favorite}/rankingByFavorite`)
      .then((res: AxiosResponse) => {
        resolve(res);
      })
      .catch((err) => {
...
export const getTimeSeriesPoints = (user: string): Promise<TimeSeriesPoints[]> => {
  return new Promise((resolve, reject) => {
    axios
      .get(`http://10.0.0.1698080api/myTable/${user}/getTimeSeriesPoints`)
      .then((res: AxiosResponse) => {
...
export const getLiveRankingForGameWeek = (gameWeek: string): Promise<LiveRanking> => {
  return new Promise((resolve, reject) => {
    axios
      .get(`http://10.0.0.1698080api/myTable/${gameWeek}/liveRanking`)
      .then((res: AxiosResponse) => {
...
//   return new Promise((resolve, reject) => {
//     axios
//       .get("http://10.0.0.1698080api/ranking/community_ranking")
//       .then((res: AxiosResponse) => {
//         resolve(res);
//       })
//       .catch((err) => {
