  ...
  return (
    <Router>
      <Routes>
        ...
        <Route path="/home/:username/:gameWeek" element={isAuthenticated ? <Home /> : <Navigate to="/login" />}/>
        <Route path="/home/:username" element={isAuthenticated ? <Home /> : <Navigate to="/login" />}/>
